CREATE DATABASE  IF NOT EXISTS `organizetedarik` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci */;
USE `organizetedarik`;
-- MySQL dump 10.13  Distrib 5.5.50, for debian-linux-gnu (x86_64)
--
-- Host: oganizetedarik.c9c97zfuzua0.eu-central-1.rds.amazonaws.com    Database: organizetedarik
-- ------------------------------------------------------
...
CREATE TABLE `company_messages` (
  ...
  `dateadd` datetime NOT NULL,
  `message_code` varchar(45) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `company_messages` VALUES (1,15,5,15,'Ürünüm Gelmedi','ürünüm gelmedi',1,'2016-11-12 21:10:12','S3K6P0R9C7K1E5S1'),(2,15,5,5,'Ürünüm Gelmedi','gelecek az kaldı',1,'2016-11-12 21:14:22','S3K6P0R9C7K1E5S1'),(3,7,5,7,'as dasdasdas','sadasd',1,'2016-11-12 23:50:04','G0U2N2U9C9T2D7'),(4,7,5,5,'as dasdasdas','sorun nedir ?',0,'2016-11-13 22:47:58','G0U2N2U9C9T2D7'),(5,15,5,15,'Ürünüm Gelmedi','bekliyoruz bakalım',1,'2016-11-13 22:48:19','S3K6P0R9C7K1E5S1'),(6,15,5,5,'Ürünüm Gelmedi','gelir ',1,'2016-11-14 20:44:02','S3K6P0R9C7K1E5S1'),(7,15,5,5,'Ürünüm Gelmedi','adasdasdas asd asd',1,'2016-11-14 20:44:19','S3K6P0R9C7K1E5S1'),(8,15,5,15,'Ürünüm Gelmedi','sadadadas sadasdas',0,'2016-11-14 20:55:18','S3K6P0R9C7K1E5S1'),(9,15,5,15,'Ürünüm Gelmedi','sdasdasdsa',0,'2016-11-14 20:55:36','S3K6P0R9C7K1E5S1');
...
CREATE TABLE `customer_testimonials` (
  ...
  `logoS3_url` varchar(255) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `newsreadip` VALUES (1,15,'127.0.0.1');
...
INSERT INTO `suppliers` VALUES (2,'samed ceylan','','imadige2@gmail.com','59a69d15bacb7e8054e966dfda8f095e',1,'',NULL,'2016-07-24 22:24:36',0,'',542145,NULL),(5,'Mehmet Şerefoğlu Tedarikçi','','memet@gmail.com','d2da1e9f79c6ca6d5d60c7a2b8673c5a',34,'',NULL,'2016-08-01 16:18:25',0,'1231231231',125012,'1231231223');
...
INSERT INTO `tenderoffers` VALUES (1,15,1,21,800.3,'2016-10-20 21:10:31'),(2,15,1,21,6500,'2016-10-20 21:33:22'),(3,15,1,21,550,'2016-10-20 21:36:48'),(4,15,1,21,5,'2016-10-20 21:45:34'),(5,15,1,21,5,'2016-10-20 21:45:40'),(6,15,1,21,5,'2016-10-20 21:48:58'),(7,15,1,21,85.4,'2016-10-20 21:52:26'),(8,15,8,21,9000,'2016-10-20 22:49:16'),(9,7,2,21,1,'2016-11-09 19:55:08');
...
-- Dump completed on 2016-11-15 13:22:52
