			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="form-group">
						<?php echo $form->labelEx($model,'socialnetwork_id',array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
						<div  class="col-md-9 col-sm-9 col-xs-12">
							<?php
							$arr=array(""=>"");

							foreach(Params::getParams("social") as $key=>$value)
							{
								$arr[$key]=$value;
							}

							echo $form->dropDownList($model,'socialnetwork_id',$arr,array('class' => 'form-control col-md-12 col-sm-12 col-xs-12')); ?>
							<?php echo $form->error($model,'socialnetwork_id',array('class'=>'text-danger')); ?>
						</div>
					</div>
					<div class="clearfix"></div>
					<br>
					<div class="form-group">
						<?php echo $form->labelEx($model,'socialnetwork_url',array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
						<div class="col-md-9 col-sm-9 col-xs-12">
							<?php echo $form->textField($model,'socialnetwork_url',array('size'=>60,'maxlength'=>80,'class' => 'form-control col-md-7 col-xs-12')); ?>
							<?php echo $form->error($model,'socialnetwork_url',array('class'=>'text-danger')); ?>
						</div>
					</div>
					<div class="clearfix"></div>
					<br>
